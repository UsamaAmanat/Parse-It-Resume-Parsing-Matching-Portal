	...
	vpb_multiple_file_uploader.prototype.vasPLUS = function(file,file_counter)
	{
		if(typeof file[file_counter] != undefined && file[file_counter] != '')
		{
			...
			else
			{
				...
				var jobid = $('#jobid').val();
				var flexRadioDefault1 = $('#flexRadioDefault1:checked').val();
				var flexRadioDefault2 = $('#flexRadioDefault2:checked').val();
				var uploaderform = $('#uploadedform').val();
				
				dataString.append('jobid',jobid);
				dataString.append('uploaderform',uploaderform);
				dataString.append('flexRadioDefault1',flexRadioDefault1);
				dataString.append('flexRadioDefault2',flexRadioDefault1);
            ...
            if (evt.lengthComputable) {
                ...
                // percentComplete = round(percentComplete,1);
				 ...
				 let progressHTML = `<li class="row">
                          ...
                          <div class="content">
                            <div class="details">
                              <span class="percent">${percentComplete}% Uploading</span>
                              <span class="percent">Do not refresh the page</span>
                            </div>
...
let progressHTML = `<li class="row">
                          ...
                          <div class="content">
                            <div class="details">
                              ...
                              <span class="percent">100% Uploaded</span>
                              <span class="percent">Files Uploaded Successfully</span>
                            </div>
                            <div class="progress-bar">
                              <div class="progress" style="width: ${percentComplete}%"></div>
                            </div>
