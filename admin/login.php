...
<head>
    <title style="color: brown">Resume Parse</title>
...
<body>
    <div class="container" id="container">
        <div class="form-container  sign-in-container">
            <form>
                <div class="header mb-5">Sign In</div>
                ...
                <div class="button-input-group">
                    ...
                    <div class="group input-group">
                        <input type="password" id="inputPassword" name="password" placeholder="Password" required pattern=".{8,}">
                    </div>


                    <div class="group button-group">
                        <button class="signin-btn" id="loginn">Sign in</button>
                    </div>
