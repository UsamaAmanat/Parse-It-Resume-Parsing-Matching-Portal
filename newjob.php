...
<div class="container mt-5">
    <div class="outerdive">
        <form class="  " id="jobdataform">
            <div class="row">
                <h1 class="h3 mb-3 font-weight-normal">Add a new Job</h1>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="Recruiter" class="form-control" name="Recruiter" placeholder="Recruiter Name">

                    <label class="">Company Name</label>
                    <input type="text" id="cname" class="form-control" name="cname" placeholder="Company Name">
                    ...
                    <div class="dropdown">
                        ...
                        <select name="jobtypedd" id="jobtypedd" class="form-control">
                            ...
                            <option value="Resume Matching">Resume Matching</option>
                            <option value="Both Parsing and Matching">Both Parsing and Matching</option>
                        </select>
                    </div>
                    ...
                    <div class="candidates_data doff mt-4 " id="candidatesSection">
                        <p>Select data field to parse from candidate resumes</p>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="isfname" value="Yes" id="flexCheckIndeterminate">
                            <label class="form-check-label">
                                First Name
                            </label>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="islname" value="Yes" id="flexCheckIndeterminate">
                            <label class="form-check-label">
                                Last Name
                            </label>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="isemail" value="Yes" id="flexCheckIndeterminate">
                            <label class="form-check-label">
                                Email
                            </label>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="isphone" value="Yes" id="flexCheckIndeterminate">
                            <label class="form-check-label">
                                Phone
                            </label>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="isaddress" value="Yes" id="flexCheckIndeterminate">
                            <label class="form-check-label">
                                Date Of Birth
                            </label>
                        </div>
        ...
        <button class="btn btn-lg btn-primary btn-block mt-3" id="submitJob" type="submit" style="width:50%;">+ Add a new Job</button>
