...
//                 if ($zip->open($zip_name, ZIPARCHIVE::CREATE) !== TRUE) {
//                     echo '<h1>Error craeting zip file</h1>';
//                 }
//                 foreach ($post['files'] as $file) {
//                     $zip->addFile($file_folder . $file);
//                 }
...
//                 }
//             } else
//             echo "<h1>* Please select file to zip</h1>";
//                 $error .= "* Please select file to zip ";
//         } 
//         else{
//         echo "<h1>* You dont have ZIP extension</h1>";
...
">
                                ...
                                <form name="zips" method="post">
                                    ...
                                    <div style="height: 350px; overflow: auto">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th style="color:blue; text-align:center;">Check</th>
        ...
        ?>
        <div class="resumebyclient" style="background-color: white; padding:15px; border-radius:10px; margin:2% 0%">




            <p class="ttte" style="padding: 10px; background: #ff7c58; border-radius: 6px; color: white; ">Upload Resume</p>

            <form name="form_id" id="form_id" action="javascript:void(0);" enctype="multipart/form-data" style="width:800px; margin-top:20px;">
                <input type="file" name="vasplus_multiple_files" id="vasplus_multiple_files" multiple="multiple" style="padding:5px;" style="border: 1px solid red;" />
